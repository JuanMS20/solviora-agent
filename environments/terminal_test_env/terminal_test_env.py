...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Solviora Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Solviora Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Solviora Agent",
    },
    {
