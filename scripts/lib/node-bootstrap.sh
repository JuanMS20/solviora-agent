...
#   2. ~/.solviora/node/ from a prior Solviora-managed install
#   3. fnm, proto, nvm (in that order) if the user already uses a version manager
#   4. Termux `pkg`, macOS Homebrew
#   5. pinned nodejs.org tarball into ~/.solviora/node/ (always works, zero shell rc edits)
#
# Usage:
...
#   SOLVIORA_HOME             (default: $HOME/.solviora, fallback: HERMES_HOME)
# ============================================================================
