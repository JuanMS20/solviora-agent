...
_UPSTREAM_REPO_URL = "https://github.com/JuanMS20/solviora-agent.git"
...
def check_for_updates() -> Optional[int]:
    """Check whether a Solviora update is available.
...
_RELEASE_URL_BASE = "https://github.com/JuanMS20/solviora-agent/releases/tag"
...
def format_banner_version_label() -> str:
    ...
    base = f"Solviora Agent v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]Solviora Agent — tu agente en la terminal[/]")
