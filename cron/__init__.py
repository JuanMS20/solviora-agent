"""
Cron job scheduling system for Solviora Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    solviora gateway install    # Install as a user service
    sudo solviora gateway install --system  # Linux servers: boot-time system service
    solviora gateway            # Or run in foreground
